...
CREATE TABLE BKBK(
 ...
 BK_INTRODUCE VARCHAR2(4000) NOT NULL,

 CONSTRAINT BKBK_PK PRIMARY KEY(BK_NO)
 );

CREATE SEQUENCE BKBK_SEQ NOCACHE;

INSERT INTO BKBK VALUES(
BKBK_SEQ.NEXTVAL, 'Booke 온앤온', '안녕하세요 북이온앤온입니다');
INSERT INTO BKBK VALUES(
BKBK_SEQ.NEXTVAL, 'Booke 온앤온2', '안녕하세요 북이온앤온2입니다');
INSERT INTO BKBK VALUES(
BKBK_SEQ.NEXTVAL, 'Booke 온앤온3', '안녕하세요 북이온앤온3입니다');
INSERT INTO BKBK VALUES(
BKBK_SEQ.NEXTVAL, 'Booke 온앤온4', '안녕하세요 북이온앤온4입니다');
INSERT INTO BKBK VALUES(
BKBK_SEQ.NEXTVAL, 'Booke 온앤온5', '안녕하세요 북이온앤온5입니다');

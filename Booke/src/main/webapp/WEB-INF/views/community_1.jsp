								...
								<div class="row row-cols-1 row-cols-md-5 g-4">
									<div class="col">
										<div class="card border-success mb-3 "
											...
											<div class="card-footer bg-transparent border-success">5명 참여중</div>
										</div>
									</div>
									<div class="col">
										<div class="card border-success mb-3 "
											...
											<div class="card-footer bg-transparent border-success">3명 참여중</div>
										</div>
									</div>
									<div class="col">
										<div class="card border-success mb-3 "
											...
											<div class="card-footer bg-transparent border-success">2명 참여중</div>
										</div>
									</div>
									<div class="col">
										<div class="card border-success mb-3 "
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="login_menu">
								...
								<div class="attainment" style="text-align: center; vertical-align: middle; horizen-align: middle; line-height: 50px;">
									<!-- 목표 달성도 -->
									<br><span style="font-size: 30px;"><input type="button" value="+ 소모임 개설" 
									onclick="location.href='communityModal.do'"></span>
								</div>
							</div>
							<div class="friend">

	...
	<div class="header">
		<div class="container">
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
				<div class="full">
					<div class="center-desk">
						<div class="logo">
							<a href="main.do"><img src="resources/images/logo1.png"
								alt="#" style="margin: 12px 0px 0px -150px;"></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xl-1 col-lg-1 col-md-1 col-sm-1">
				<div class="menu-area1">
					<div class="limit-box menu-area-main"
						style="margin: 15px 0px 0px -200px;">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
				<div class="menu-area">
					<div class="limit-box menu-area-main1" style="margin: 7px 0px 0px 0px;">

...
td>#btn {
	...
	onload=function(){
		var id = opener.document.getElementsByName("be_id")[0].value;
...
<body class="text-center">
	...
	<img class="mb-4" src="resources/images/bk.gif" alt="#" width="130">
		...
		<table border="1">
			...
			<tr>
				<td colspan="2" style="background-color: rgb(100, 172, 184);"><input type="button" value="확인" class="form-control" id="btn" onclick="idChk();"></td>
			</tr>
		</table>
		</div>
	</main>
